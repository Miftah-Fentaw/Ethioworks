      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: [
                  ...
                  if (application.applicantTitle != null) ...[
                    ...
                    Text(application.applicantTitle!, style: theme.textTheme.bodyLarge?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                  ],
                ],
              ),
            ),
            ...
            _buildInfoRow(Icons.phone, 'Phone', application.phoneNo, theme),
            _buildInfoRow(Icons.telegram, 'Telegram', application.telegramUsername, theme),
            const SizedBox(height: AppSpacing.lg),
            ...
            if (application.portfolioLinks.isNotEmpty) ...[
              ...
              ...application.portfolioLinks.map((link) => Padding(
                ...
                child: InkWell(
                  onTap: () {},
                  child: Text(link, style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.primary, decoration: TextDecoration.underline)),
                ),
              )),
            ],
          ],
