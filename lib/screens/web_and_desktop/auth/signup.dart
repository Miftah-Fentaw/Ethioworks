  ...
  Widget _buildFormContent() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: AppSpacing.xl),
        Text('I am a', style: theme.textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w600)),
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _selectedUserType == UserType.jobSeeker ? theme.colorScheme.primary : Colors.transparent,
                      borderRadius: BorderRadius.circular(AppRadius.md),
                    ),
                    child: Column(
                      children: [
                        Icon(Icons.person_search, color: _selectedUserType == UserType.jobSeeker ? theme.colorScheme.onPrimary : theme.colorScheme.onSurfaceVariant),
                        const SizedBox(height: AppSpacing.sm),
                        Text('Job Seeker', style: theme.textTheme.labelLarge?.copyWith(
                          color: _selectedUserType == UserType.jobSeeker ? theme.colorScheme.onPrimary : theme.colorScheme.onSurfaceVariant,
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    padding: AppSpacing.paddingMd,
                    decoration: BoxDecoration(
                      color: _selectedUserType == UserType.employer ? theme.colorScheme.primary : Colors.transparent,
                      borderRadius: BorderRadius.circular(AppRadius.md),
                    ),
                    child: Column(
                      children: [
                        Icon(Icons.business, color: _selectedUserType == UserType.employer ? theme.colorScheme.onPrimary : theme.colorScheme.onSurfaceVariant),
                        const SizedBox(height: AppSpacing.sm),
                        Text('Employer', style: theme.textTheme.labelLarge?.copyWith(
                          color: _selectedUserType == UserType.employer ? theme.colorScheme.onPrimary : theme.colorScheme.onSurfaceVariant,
                          fontWeight: FontWeight.w600,
                        )),
                      ],
                    ),
        ...
        Row(
          children: [
            ...
            Padding(padding: AppSpacing.horizontalMd, child: Text('OR', style: theme.textTheme.bodySmall)),
            Expanded(child: Divider(color: theme.colorScheme.outline)),
          ],
        ),
        const SizedBox(height: AppSpacing.lg),
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const WebLoginScreen())),
              child: Text('Log In', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.primary, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ],
